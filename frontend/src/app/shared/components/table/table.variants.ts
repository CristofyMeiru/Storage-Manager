...
export const tableHeaderVariants = cva('border', {
  variants: {},
  defaultVariants: {},
});

export const tableBodyVariants = cva('border', {
  variants: {},
  defaultVariants: {},
});
...
export const tableHeadVariants = cva(
  'border h-10 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
  {
    variants: {},
    defaultVariants: {},
  }
